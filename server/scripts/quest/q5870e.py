# id 5870 ([Maple Rewards] Gollux Annihilation and Golden Glory), field 993017200
...
sm.createQuestWithQRValue(18192, "count=2;val2=40;tDate=19/06/23/11/48;val=90")
sm.createQuestWithQRValue(18192, "count=2;val2=90;tDate=19/06/23/11/48;val=90")
sm.createQuestWithQRValue(18192, "count=3;val2=90;tDate=19/06/23/11/48;val=90")
sm.completeQuestNoCheck(parentID)
sm.createQuestWithQRValue(18442, "HR=0;VE=0;NO=0;GX=1;RM=0;KX=0;EM=0")
sm.setParam(0)
