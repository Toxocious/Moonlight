...
sm.setParam(4)
res = sm.sendAskYesNo("I saw an Oda Spirit Walker carrying a suspicious jar. I think that might be what they are referring to. Can you get some for me, please?")
