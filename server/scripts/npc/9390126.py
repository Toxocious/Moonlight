...
if sm.getFieldID() == 863010000:
    ...
    for i in range(len(destinations)):
        dialog += "#L%d##bGo to the Road to Gollux (%s Mode) #r(Lv. %d+)#b#l\r\n" % (i, destinations[i][0], destinations[i][1])
    ...
    if sm.getParty() is None:
        ...
        sm.sendSayOkay("Please have your party leader talk to me if you wish to face the #bLegendary Gollux#k.")
        sm.dispose()
