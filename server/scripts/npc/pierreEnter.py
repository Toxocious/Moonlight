...
destinations = [
    ["Normal", 100, 105200200, 5, EventType.Clown, 64800000],
    ["Chaos", 220, 105200600, 5, EventType.CClown, 64800000],
]
...
if sm.getFieldID() == 105200000:
    ...
    if sm.getParty() is None:
        ...
        sm.sendSayOkay("Please have your party leader talk to me if you wish to face #bPierre#k.")
        sm.dispose()
        ...
        sm.sendNext("You or one of your party member has already attempted facing #bPierre#k within the past 18 Hours.\r\n\r\nYou have " + timeUntilReset + " left on your cooldown.")
        sm.dispose()
