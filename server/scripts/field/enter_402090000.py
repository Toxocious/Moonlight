...
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#For too long, we endured war for the sake of war.", 50, 7350, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(8150)
sm.playExclSoundWithDownBGM("Voice4.img/GLAdd/Mono/AA/2", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#We championed selfish causes for misguided leaders.", 50, 7650, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(6200)
sm.playExclSoundWithDownBGM("Voice4.img/GLAdd/Mono/AA/3", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#We wasted countless lives for nothing.", 50, 5700, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(9500)
sm.playExclSoundWithDownBGM("Voice4.img/GLAdd/Mono/AA/4", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#But now, we must rise together as one for a greater purpose.", 50, 9000, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(7100)
sm.playExclSoundWithDownBGM("Voice4.img/GLAdd/Mono/AA/5", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#By fighting together, we can end this chaos.", 50, 6600, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(2500)
sm.playExclSoundWithDownBGM("Voice4.img/GLAdd/Mono/AA/6", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#Join me!", 50, 2000, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(7250)
sm.playExclSoundWithDownBGM("Voice4.img/GLAdd/Mono/AA/7", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#Dedicate your lives to the glory of our race.", 50, 6750, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(10550)
sm.playExclSoundWithDownBGM("Voice4.img/GLAdd/Mono/AA/8", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#It is time for the noble High Flora to lead Grandis into a new age!", 50, 10050, 7, 0, -50, 0, 4, 3, 300, 300)
...
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs45#But fate had other plans for me.", 50, 4800, 4, 0, 0, 0, 4, 3, 300, 300)
sm.sendDelay(1000)
...
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#I did all I could, but it wasn't enough.", 50, 6000, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(6800)
sm.playExclSoundWithDownBGM("Voice4.img/Ark/Back/A/Male/2", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#Maybe it was always meant to end this way.", 50, 6300, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(4400)
sm.playExclSoundWithDownBGM("Voice4.img/Ark/Back/A/Male/3", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#Or maybe it was just me...", 50, 3900, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(3500)
sm.playExclSoundWithDownBGM("Voice4.img/Ark/Back/A/Male/4", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs35#Is this how it ends?", 50, 3000, 7, 0, -50, 0, 4, 3, 300, 300)
sm.sendDelay(1000)
sm.offLayer(300, "d1", False)
sm.sendDelay(1000)
sm.sendDelay(2500)
sm.playExclSoundWithDownBGM("Voice4.img/ArkNpc/Back/A/7", 100)
sm.createFieldTextEffect("#fnﾳﾪﾴﾮﾰ￭ﾵ￱ ExtraBold##fs65#Ark!", 50, 2000, 4, 0, 0, 0, 4, 3, 300, 300)
