...
sm.sendNext("#face0#Did it work?")
sm.setInnerOverrideSpeakerTemplateID(3001300) # Ex
sm.sendSay("#face0#You did manage to defeat the hedgehogs, yes, though unfortunately, they weren't carrying the parts you need. Try hunting more.")
sm.setInnerOverrideSpeakerTemplateID(3001350) # Illium
sm.sendSay("#face0#Sounds good. That was easier than I expected, and I really need those parts.")
sm.warp(940203000)
