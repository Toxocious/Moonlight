# id 26509 ([Maple Rewards] Theme Dungeon: Annihilate the Mole King), field 993017200
sm.createQuestWithQRValue(18192, "count=0;val2=0;tDate=19/06/23/11/48;val=0")
...
sm.createQuestWithQRValue(18192, "count=0;val2=0;tDate=19/06/23/11/48;val=20")
sm.createQuestWithQRValue(18192, "count=0;val2=20;tDate=19/06/23/11/48;val=20")
sm.createQuestWithQRValue(18192, "count=1;val2=20;tDate=19/06/23/11/48;val=20")
sm.completeQuestNoCheck(parentID)
sm.createQuestWithQRValue(18272, "A=1;B=0;C=0;D=0;E=0;F=0;G=0;H=0;I=0;J=0;K=0;L=0;M=0")
sm.setParam(0)
