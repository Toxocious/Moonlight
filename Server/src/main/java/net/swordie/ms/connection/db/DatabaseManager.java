...
public class DatabaseManager {
  ...
  public static Object getObjFromDB(Class clazz, String columnName,
                                    Object value) {
    Object o = null;
    try (Session session = getSession()) {
      ...
      javax.persistence.Query query = session.createQuery(String.format(
          "FROM %s WHERE %s = :val", clazz.getName(), columnName));
  ...
  public static Object getObjListFromDB(Class clazz) {
    ...
    try (Session session = getSession()) {
      ...
      javax.persistence.Query query =
          session.createQuery(String.format("FROM %s", clazz.getName()));
  ...
  public static Object getObjListFromDB(Class clazz, String columnName,
                                        Object value) {
    List list;
    try (Session session = getSession()) {
      Transaction transaction = session.beginTransaction();
  ...
  public static void modifyObjectFromDB(Class clazz, int id, String columnName,
                                        Object value) {
    ...
    try {
      ...
      javax.persistence.Query query = session.createQuery(
          String.format("UPDATE %s SET %s = :val WHERE id = :objid",
                        clazz.getName(), columnName));
